...
export default function Footer() {
  ...
  return (
    ...
    >
      <p>
        <span class={tw`font-bold`}>©</span> Jamalam, {new Date().getFullYear()}
      </p>
      <ul class={tw`flex flex-row`}>
        <li
          class={navLink}
        >
          <a href="https://github.com/Jamalam360">
        ...
        <li
          class={navLink}
        >
          <a href="https://maven.jamalam.tech">
            <i class={"fa-brands fa-java " + icon} />
          </a>
        </li>
      </ul>
    </div>
